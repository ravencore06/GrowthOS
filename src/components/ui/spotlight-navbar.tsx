  ...
  return (
    <div className={cn("relative flex justify-center pt-10", className)}>
      <nav
        ref={navRef}
        className={cn(
          "relative h-11 rounded-full transition-all duration-300 overflow-hidden border border-white/10 bg-black/50 backdrop-blur-md"
        )}
      >
        {/* Content */}
      ...
      */}
      <style jsx>{`
        nav {
          /* Default to Dark Mode Colors since app background is black */
